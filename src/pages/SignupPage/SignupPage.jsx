        ...
        <Grid textAlign='center' style={{ height: '100vh' }} verticalAlign='middle'>
          <Grid.Column style={{ maxWidth: 450 }}>
              <Header as='h2' color='red' textAlign='center'>
                <Image src='https://d20diaries.files.wordpress.com/2017/12/d20-icon-34414-jpeg.png' /> Sign Up    
              </Header>            
                ...
                <Segment stacked>               
                    ...
                    <Form.Input     
                      ...
                      required
                    />
                    <Form.TextArea label='Bio' placeholder='Tell us something epic about you...' name="bio" onChange={handleChange}/>
                    <Form.Field> 
                        <Form.Input
                          type="file"
                          name="photo"
